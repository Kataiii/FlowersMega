...
export const errorMessageEmail = "Некорректно введена почта";
export const regExName = /^[a-zA-Zа-яА-��ё��]+$/;
export const errorMessageName = "Некорректно введенное имя";
export const errorMessageCity = "Некорректно введен город/область";
export const errorMessageStreet = "Некорректно введена улица";  