...
const BlockAdvantages: React.FC = () => {
    ...
    return(
        <Container>
            ...
            <Content>Наша команда стостоит из специалистов в области флористики, дизайна, прожаж, логистики и маркетинга. У нас всегда представлен широкий ассортимент цветов. Наш каталог насчитывает много десятков наименований букетов которые порадуют ваших близких.</Content>
        </Container>
    )
}
