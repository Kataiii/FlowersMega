...
const CardCategory: React.FC<CardCategoryProps> = ({category, clickHandler}) => {
    ...
    return(
        <div onClick={clickHandler} style={{cursor: "pointer", width: "180px", boxShadow: "0px 0px 2px 0px #EEB2CE", backgroundColor: "var(--block-bg-color)", borderRadius: "6px", padding: "10px 8px", display: "flex", flexDirection: "column", gap: "10px"}}>
            <img style={{width: '164px', height: '164px', borderRadius: '6px'}} src={`${API_URL}/categories/${category.id}/${category.url}`} alt={category.name}/>
